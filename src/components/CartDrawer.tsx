  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-copper hover:bg-copper-bright transition-colors text-ink font-mono text-xs font-medium px-4 py-3 shadow-lg"
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          />
          <div className="relative w-full max-w-sm bg-surface border-l border-line h-full overflow-y-auto p-6">
